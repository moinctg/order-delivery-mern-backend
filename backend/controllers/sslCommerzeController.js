...
// Extract PaymentSession from SSLCommerz
import  shortid from "shortid";
// import  OrderSSLModel from  '../models/OrderSSLModel'
...
import Order from '../models/OrderSSLModel.js';
...
//   } else {
//     const currentOrder = OrderSSLModel.findByIdAndUpdate(transactionId, {
//       paymentDone: true,
//       updatedAt: Date.now(),
//     });
...
const  SSLCommerz_payment_fail = (req, res) => {
  res.redirect(`${process.env.CLIENT_URL}/checkout/fail`);
};

const SSLCommerz_payment_cancel = (req, res) => {
